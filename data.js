...
const DEFAULT_TRIP = {
  ...
  itinerary: [
    {
      date: "2026-11-03", label: "Day 1 — Tue", city: "En route → Tokyo", hotel: "Shinjuku hotel (TBD)",
      summary: "Overnight flight to Tokyo, arrive and settle in.",
      slots: {
        morning: [
          { title: "Depart LAX", desc: "Overnight flight to Tokyo Narita.", tag: "travel" }
        ],
        lunch: [
          { title: "In-flight meal", desc: "Somewhere over the Pacific.", tag: "travel" }
        ],
        afternoon: [
          { title: "Arrive Narita, immigration & transfer", desc: "Clear customs, then transfer to the Shinjuku hotel.", place: "Narita Airport", tag: "travel" },
          { title: "On your own", desc: "Handle your own arrival pace / rest.", tag: "own" }
        ],
        dinner: [
          { title: "Izakaya near Shinjuku", desc: "Casual, seated, easy group dinner to kick things off.", place: "Shinjuku izakaya", city: "Tokyo", tag: "easy" },
          { title: "Omoide Yokocho food alley", desc: "Tiny lantern-lit alley of yakitori stalls — lively, more standing/walking.", place: "Omoide Yokocho", city: "Tokyo", tag: "foodie" },
          { title: "On your own", desc: "Grab something near the hotel and rest up.", tag: "own" }
        ],
        night: [
          { title: "Early rest / jet lag recovery", desc: "First night — let everyone sleep it off.", tag: "easy" },
          { title: "Golden Gai bar hopping", desc: "Tiny themed bars, narrow alleys — fun but a late one.", place: "Golden Gai", city: "Tokyo", tag: "active" },
          { title: "On your own", desc: "", tag: "own" }
        ]
      }
    },
    {
      date: "2026-11-04", label: "Day 2 — Wed", city: "Tokyo", hotel: "Shinjuku hotel (TBD)",
      summary: "First full Tokyo day.",
      slots: {
        morning: [
          { title: "Meiji Shrine + Yoyogi Park", desc: "Flat gravel paths through a forested shrine — easy pace, benches throughout.", place: "Meiji Shrine", city: "Tokyo", tag: "easy" },
          { title: "Shibuya Sky observation deck", desc: "Rooftop views over the crossing — elevators, some lines.", place: "Shibuya Sky", city: "Tokyo", tag: "active" },
          { title: "On your own", desc: "", tag: "own" }
        ],
        lunch: [
          { title: "Shinjuku Station depachika food hall", desc: "Department-store basement food hall — grab and sit, very easy.", place: "Shinjuku depachika", city: "Tokyo", tag: "easy" },
          { title: "Ramen alley", desc: "Pick a counter-seat ramen shop in Shinjuku.", place: "Omoide Yokocho ramen", city: "Tokyo", tag: "foodie" },
          { title: "On your own", desc: "", tag: "own" }
        ],
        afternoon: [
          { title: "Shinjuku Gyoen National Garden", desc: "Paved paths, benches, gorgeous grounds — great easy option.", place: "Shinjuku Gyoen", city: "Tokyo", tag: "easy" },
          { title: "teamLab Planets Tokyo", desc: "Immersive digital art — barefoot, some wading/walking. Pre-book tickets.", place: "teamLab Planets", city: "Tokyo", tag: "active" },
          { title: "On your own", desc: "", tag: "own" }
        ],
        dinner: [
          { title: "Family-style yakiniku", desc: "Seated Korean-Japanese BBQ, easy for a big group.", place: "Yakiniku restaurant", city: "Tokyo", tag: "easy" },
          { title: "Kabukicho dinner show", desc: "Over-the-top dinner entertainment — novelty option.", place: "Kabukicho", city: "Tokyo", tag: "active" },
          { title: "On your own", desc: "", tag: "own" }
        ],
        night: [
          { title: "Hotel rest", desc: "", tag: "easy" },
          { title: "Tokyo Metropolitan Building night view", desc: "Free observation deck, no crowds like Shibuya Sky.", place: "Tokyo Metropolitan Government Building", city: "Tokyo", tag: "easy" },
          { title: "On your own", desc: "", tag: "own" }
        ]
      }
    },
